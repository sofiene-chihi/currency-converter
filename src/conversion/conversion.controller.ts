...
export class ConversionController {
  ...
  @Post('convert')
  createConversion(@Body() createConversionDto: CreateConversionDto, @Request() req): Promise<Conversion> {
    return this.conversionService.createConversion(createConversionDto, req.user);
  }
